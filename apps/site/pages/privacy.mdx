...
Welcome to [Flexstart.org](/) (the "Site"), hosted by Flexstart ("Flexstart", "we", "us", and/or "our"). Flexstart provides a platform to run and scale containerized applications (the "Services"). We value your privacy and are dedicated to protecting your personal data. This Privacy Policy covers how we collect, handle, and disclose personal data on our Platform.
...
## Verbal Consent Collection Process  

We collect verbal consent from our clients before sending them messages by clearly explaining the purpose of our communications and obtaining their explicit agreement. During phone interactions, our representatives inform clients that they may receive important updates, notifications, or other relevant messages from us via SMS. Clients are asked to confirm their consent verbally.
...
For privacy-related questions, please contact us at privacy@flexstart.org.
