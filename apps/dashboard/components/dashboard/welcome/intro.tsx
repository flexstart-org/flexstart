...
export default function Intro() {
  ...
  const [showText] = useDebounce(loading ? true : true, 800);
    ...
    >
      ...
      >
        {/* <Spline
          ...
          scene="https://prod.spline.design/fjdshjfjgsa/scene.splinecode"
        /> */}
      </div>
      {showText && (
        <motion.div
        ...
        >
          ...
          >
            Welcome to Flexstart
          </motion.h1>
          <motion.p
            className="max-w-md text-gray-600 transition-colors sm:text-lg"
            variants={STAGGER_CHILD_VARIANTS}
          >
            Flexstart gives you superpowers to run and scale containerized apps
            with ease.
          </motion.p>
          <motion.button
            variants={STAGGER_CHILD_VARIANTS}
