    ...
    <Mjml>
      ...
      <MjmlBody width={500}>
        <MjmlWrapper cssClass="container">
          <Header title="New Features from Flexstart" />
          ...
          <MjmlSection cssClass="smooth">
            <MjmlColumn>
              ...
              <MjmlText cssClass="paragraph">
                See{" "}
                <a href="https://flexstart.org#features" target="_blank">
                  how this works
                </a>
                .
              </MjmlText>
              ...
              <MjmlText cssClass="paragraph">
                With Flexstart, you can do that for $0/mo.
              </MjmlText>
              <MjmlText cssClass="paragraph">
                Start{" "}
                <a href="https://flexstart.org" target="_blank">
              ...
              <MjmlText cssClass="paragraph">
                Flexstart provides powerful analytics for your links:
              </MjmlText>
              <MjmlText cssClass="li">
              ...
              <MjmlText cssClass="paragraph">
                ...
                <a href="https://flexstart.org/stats/github" target="_blank">
                  here
                </a>
                .
              </MjmlText>
              ...
              <MjmlText cssClass="paragraph">
                Flexstart allows you to generate QR codes of your short links
                for free.
              </MjmlText>
              <MjmlText cssClass="paragraph">
              ...
              <MjmlText cssClass="paragraph">
                ...
                to invite your friends & teammates to your Flexstart project.
              </MjmlText>
              <MjmlText cssClass="paragraph">
                With Flexstart, you get unlimited team invites for every project – no
