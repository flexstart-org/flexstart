...
const pricingItems = [
  ...
  },
  {
    ...
    cta: "Contact us",
    ctaLink:
      "mailto:mail@flexstart.org?subject=Interested%20in%20Flexstart%20Enterprise",
  },
];
    ...
    <MaxWidthWrapper className="my-20 text-center">
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
        {pricingItems.map(({ plan, tagline, quota, features, cta }) => {
          const highlighted = user?.plan && user.plan === plan.toLowerCase();
              ...
              <div className="p-5">
                <button
                  ...
                  onClick={() => {
                    setClicked(true);
                    fetch(
                      `/api/stripe/upgrade?priceId=${PRO_TIERS[tier].price[period].priceIds[env]}`,
                      {
                        method: "POST",
                      }
                    )
