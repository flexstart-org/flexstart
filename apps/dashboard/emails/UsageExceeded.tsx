          ...
          <MjmlSection cssClass="smooth">
            <MjmlColumn>
              ...
              <MjmlText cssClass="paragraph">
                ...
                limit of <strong>{nFormatter(usageLimit)} pods</strong>. You
                have used <strong>{nFormatter(usage, 2)} pods</strong> across
                all your projects in your current billing cycle.
              </MjmlText>
              <MjmlText cssClass="paragraph">
                All your existing pods will continue to work, but you'll need to
                upgrade to add more pods.
              </MjmlText>
              <ButtonPrimary
                link={`https://flexstart.org/settings`}
