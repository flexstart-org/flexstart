...
import { useDeleteProjectModal } from "components/dashboard/modals/delete-project-modal";
    ...
    <div className="rounded-lg border border-gray-200 bg-white">
      ...
      <div className="flex flex-col space-y-3 p-5 sm:p-10">
        ...
        <p className="text-sm text-gray-500">
          ...
          resources + their configurations. This action cannot be undone - please proceed
          with caution.
        </p>
      </div>
