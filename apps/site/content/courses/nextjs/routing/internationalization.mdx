...
```js filename="app/[lang]/page.js" showLineNumbers
...
```json filename="dictionaries/en.json" showLineNumbers
{
  "products": {
    "cart": "Add to Cart"
  }
...
```json filename="dictionaries/nl.json" showLineNumbers
{
  "products": {
...
```js filename="app/[lang]/dictionaries.js" showLineNumbers
import 'server-only'
...
```js filename="app/[lang]/layout.js" showLineNumbers
