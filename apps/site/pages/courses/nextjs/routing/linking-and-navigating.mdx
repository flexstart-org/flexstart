...
There are optional props you can pass to `<Link>`. See the [API reference](/learn/nextjs/components/link) for more information.
...
```tsx filename="app/blog/PostList.jsx" showLineNumbers
import Link from "next/link";
...
```tsx filename="app/ui/Navigation.jsx" showLineNumbers
"use client";
...
```tsx filename="app/page.jsx" showLineNumbers
'use client';
